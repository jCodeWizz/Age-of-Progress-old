...
public class UIButton extends UIElement {
	...
	public UIButton(String id, int x, int y, int w, int h, String text) {
		super(id, x, y, w, h);
		this.text = text;
		this.button = Assets.getSprite("button");
		this.buttonPressed = Assets.getSprite("button-pressed");
		this.buttonUnavailable = Assets.getSprite("button-unavailable");
