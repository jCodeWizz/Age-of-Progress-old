...
public class Cell {
	...
	public Cell(int x, int y, int tileX, int tileY, boolean odd, World world) {
		...
		this.world = world;
		this.tile = new GameObject("Tile", new Transform(new Vector2f(tileX, tileY), new Vector2f(Tile.WIDTH, Tile.HEIGHT)), -2).addComponent(new SpriteRenderer(new Sprite(AssetPool.getTexture(".//res/assets/textures/environment/base-tile.png"))));
